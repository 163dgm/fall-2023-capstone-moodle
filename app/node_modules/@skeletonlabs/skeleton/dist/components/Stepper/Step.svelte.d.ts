...
import type { StepperEventDispatcher, StepperState } from '@skeletonlabs/skeleton/dist/components/Stepper/types.js';
import type { Transition, TransitionParams } from '@skeletonlabs/skeleton/index.js';
