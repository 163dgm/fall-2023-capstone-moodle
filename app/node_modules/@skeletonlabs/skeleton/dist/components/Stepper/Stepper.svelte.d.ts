...
import { type Transition, type TransitionParams } from '@skeletonlabs/skeleton/index.js';
type FadeTransition = typeof fade;
import type { StepperButton, StepperState } from '@skeletonlabs/skeleton/dist/components/Stepper/types.js';
